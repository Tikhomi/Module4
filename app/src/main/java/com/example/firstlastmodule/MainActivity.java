...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            String searchText = search.getText().toString(); // считывание введённого текста
            int searchLength = Integer.parseInt(searchText);
            mapPoem = stringMapPoem(poem);
            String resultSearch = searchMapPoem(searchLength, mapPoem);

            output.setText(resultSearch);
        }
    };

    // Метод поиска информации в мап по длине строки
    private String searchMapPoem(int length, Map<Integer, String> map) {
        StringBuilder result = new StringBuilder();
        int count = 0;

        for (Integer key : map.keySet()) {
            String currentLine = map.get(key);
        ...
        if (count == 0) {
            return "Строки указанной длины не найдены.";
        } else {
            return "Найдено строк: " + count + result.toString();
        }
    }
